...
public final class LogConstant {
    ...
    public static final String DELETING_BRAND_WITH_ID = ANSI_BLUE + "Deleting brand with id: " + ANSI_RESET + ANSI_BOLD + "{}" + ANSI_RESET;
    ...
    public static final String ERROR_CREATING_BRAND = ANSI_RED + "An error occurred while creating the brand" + ANSI_RESET;
    public static final String ERROR_UPDATING_BRAND = ANSI_RED + "An error occurred while updating the brand" + ANSI_RESET;
    public static final String ERROR_GETTING_BRAND_DETAILS = ANSI_RED + "An error occurred while retrieving brand details" + ANSI_RESET;
    public static final String ERROR_RETRIEVING_ALL_BRANDS = ANSI_RED + "An error occurred while retrieving all brands" + ANSI_RESET;
    public static final String ERROR_RETRIEVING_BRANDS_BY_DELETED_STATE = ANSI_RED + "An error occurred while retrieving brands by deleted state" + ANSI_RESET;
    public static final String ERROR_DELETING_BRAND = ANSI_RED + "An error occurred while deleting brand" + ANSI_RESET;
}
