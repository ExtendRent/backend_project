...
public class CarModelController extends BaseController {
    ...
    public ResponseEntity<TResponse<CarModelResponse>> getByCarModelId(@PathVariable int id) {
        ...
        CarModelResponse response = carModelService.getById(id);
    ...
    public ResponseEntity<TResponse<List<CarModelResponse>>> getAll() {
        ...
        List<CarModelResponse> response = carModelService.getAll();
        log.info(RETRIEVED_ALL_CAR_MODELS, response.size());
        return answer(response, HttpStatus.OK);
    }

    @GetMapping("/brands/{brandId}")
    public ResponseEntity<TResponse<List<CarModelResponse>>> getByBrandId(@PathVariable int brandId) {
        log.info(RETRIEVING_CAR_MODELS_BY_BRAND_ID, brandId);
        List<CarModelResponse> response = carModelService.getAllByBrandId(brandId);
        return answer(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<TResponse<List<CarModelResponse>>> getAllByDeletedState(
        ...
        List<CarModelResponse> response = carModelService.getAllByDeletedState(isDeleted);
    ...
    public ResponseEntity<Void> delete(
        ...
        carModelService.delete(id, isHardDelete);
