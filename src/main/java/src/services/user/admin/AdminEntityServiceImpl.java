...
import static src.core.exception.exception_types.NotFoundExceptionType.ADMIN_DATA_NOT_FOUND;
import static src.data.enums.default_data_enums.status.DefaultUserStatus.VERIFIED;
