...
import src.repositories.paperwork.RentalRepository;
import src.services.paperwork.discount.DiscountEntityService;
import src.services.system.SysPaymentDetailsService;
import src.services.user.customer.CustomerEntityService;
import src.services.vehicle.car.CarEntityService;
import src.services.vehicle.car.CarService;

import java.time.LocalDate;
import java.util.List;

import static src.core.exception.exception_types.NotFoundExceptionType.RENTAL_DATA_NOT_FOUND;
import static src.data.enums.default_data_enums.status.DefaultRentalStatus.WAITING;
