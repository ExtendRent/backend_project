...
import src.repositories.vehicle_features.CarModelRepository;
import src.services.businessrules.abstracts.BaseItemRules;
import src.services.vehicle_features.common_features.brand.BrandEntityService;

import java.util.List;

import static src.core.exception.exception_types.AlreadyExistsExceptionType.MODEL_ALREADY_EXISTS;
import static src.core.exception.exception_types.NotFoundExceptionType.MODEL_LIST_NOT_FOUND;
