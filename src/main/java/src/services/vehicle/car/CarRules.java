...
import static src.core.exception.exception_types.AlreadyExistsExceptionType.LICENSE_PLATE_ALREADY_EXISTS;
import static src.core.exception.exception_types.NotFoundExceptionType.CAR_LIST_NOT_FOUND;
